			...
			cache.ResourceEventHandlerFuncs{
				AddFunc: func(obj interface{}) {
					...
					if ciliumNode := k8s.ObjToCiliumNode(obj); ciliumNode != nil {
						...
						errs := k.CiliumNodeChain.OnAddCiliumNode(ciliumNode)
						if n.IsLocal() {
							return
						}
				...
				UpdateFunc: func(oldObj, newObj interface{}) {
					...
					if oldCN := k8s.ObjToCiliumNode(oldObj); oldCN != nil {
						if ciliumNode := k8s.ObjToCiliumNode(newObj); ciliumNode != nil {
							...
							n := nodeTypes.ParseCiliumNode(ciliumNode)
							errs := k.CiliumNodeChain.OnUpdateCiliumNode(oldCN, ciliumNode)
							if n.IsLocal() {
								return
							}
							k.nodeDiscoverManager.NodeUpdated(n)
				...
				DeleteFunc: func(obj interface{}) {
					...
					valid = true
					n := nodeTypes.ParseCiliumNode(ciliumNode)
					errs := k.CiliumNodeChain.OnDeleteCiliumNode(ciliumNode)
					if errs != nil {
						valid = false
					}
