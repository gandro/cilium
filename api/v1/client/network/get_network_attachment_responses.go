...
func (o *GetNetworkAttachmentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 404:
		result := NewGetNetworkAttachmentNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetNetworkAttachmentNotFound creates a GetNetworkAttachmentNotFound with default headers values
func NewGetNetworkAttachmentNotFound() *GetNetworkAttachmentNotFound {
	return &GetNetworkAttachmentNotFound{}
}

/*
GetNetworkAttachmentNotFound describes a response with status code 404, with default header values.

No network attachments found
*/
type GetNetworkAttachmentNotFound struct {
}

// IsSuccess returns true when this get network attachment not found response has a 2xx status code
func (o *GetNetworkAttachmentNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get network attachment not found response has a 3xx status code
func (o *GetNetworkAttachmentNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get network attachment not found response has a 4xx status code
func (o *GetNetworkAttachmentNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this get network attachment not found response has a 5xx status code
func (o *GetNetworkAttachmentNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this get network attachment not found response a status code equal to that given
func (o *GetNetworkAttachmentNotFound) IsCode(code int) bool {
	return code == 404
}

func (o *GetNetworkAttachmentNotFound) Error() string {
	return fmt.Sprintf("[GET /network/attachment][%d] getNetworkAttachmentNotFound ", 404)
}

func (o *GetNetworkAttachmentNotFound) String() string {
	return fmt.Sprintf("[GET /network/attachment][%d] getNetworkAttachmentNotFound ", 404)
}

func (o *GetNetworkAttachmentNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
